    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="w-64 border-r bg-muted/10">
            ...
            <div className="space-y-1">
              ...
              <div className="space-y-1">
                ...
                <NavLink
                  to="/chat/ABC"
                  className={({ isActive }) =>
                    isActive ? "w-full justify-start flex items-center gap-3 transition-all" : "w-full justify-start"
                  }
                >
        ...
        <div className="p-4 border-t">
          <Button onClick={onLogout} variant={"default"} size={"sm"} className="w-full cursor-pointer">
